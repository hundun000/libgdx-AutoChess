...
public final class FenParserTest {
    ...
    public void testWriteFEN2() {
        ...
        final MoveTransition t2 = t1.getLatestBoard().getCurrentPlayer().makeMove(Move.MoveFactory.createMove(t1.getLatestBoard(), BoardUtils.getPieceAtPosition(board, "c7"), BoardUtils.getCoordinateAtPosition("c5")));
